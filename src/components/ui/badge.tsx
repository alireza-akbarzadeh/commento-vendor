...
const badgeVariants = cva(
  "inline-flex items-center  text-nowrap border px-4 py-1.5 text-labelXSmall rounded-S transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
