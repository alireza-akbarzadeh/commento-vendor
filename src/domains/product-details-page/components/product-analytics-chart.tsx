...
import { TabsVisualizer } from "domains/home/components/data-visualizer/tabs-visualizer";
import { SortingChart } from "./sorting-chart";
...
export const ProductAnalyticsChart = () => {
  ...
  return (
    <div className="rounded-XL border border-border-lighter bg-background-lightest p-6">
      <SortingChart />
      <ChartContainer config={chartConfig} className="h-[332px] w-full">
        <LineChart
          accessibilityLayer
          data={chartData}
          margin={{
